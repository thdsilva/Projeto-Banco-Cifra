     ...
     <body>
          <div id="conteudo">
               <?php
                    if ($_SESSION['login']){
               ?>
                         <h1><span class="destaca"><?php echo $_SESSION['nome_usuario']; ?></span>, seja bem-vindo a Área do Cliente</h1>
                         <div class="borda"></div>
                         <div class="logout">
                              <p class="sairSistema"><a href="logout.php">Clique aqui</a> para sair do sistema</p>
                         </div>
                         <div class="clear"></div>
                         <h3>Conteúdo exclusivo para clientes do Banco Cifra Digital</h3>
